...
using CoreAndFoodWeb.Data;
using CoreAndFoodWeb.Data.Models;
...
namespace CoreAndFoodWeb.Controllers
{
    ...
    public class ChartController : Controller
    {
        ...
        public IActionResult Statistics()
        {
            ...
            var deger6 = c.Foods.Where(x =>
                x.CategoryID == c.Categories.Where(y => y.CategoryName == "Legumes").Select(z => z.CategoryID)
